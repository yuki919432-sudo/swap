...
Everything needed to submit SWAP! to App Review, in one place. Code-side items are
done; the remaining work is owner/human (accounts, hosting, sign-off, screenshots),
tracked in the audit's checklist.
...
Related: [../PRODUCTION_READINESS.md](../PRODUCTION_READINESS.md) (backend go-live),
[../BUILD_AND_ENVIRONMENTS.md](../BUILD_AND_ENVIRONMENTS.md) (EAS build),
[../legal/](../legal/) (Privacy Policy, Terms/EULA, Community Guidelines drafts).

> Legal drafts require counsel sign-off and hosting before submission; they are
> intentionally marked as drafts.
