...
import { demoSchools, demoProfiles, demoListings, demoCommunity, demoInbox } from ".";

const everything = JSON.stringify({ demoSchools, demoProfiles, demoListings, demoCommunity, demoInbox });
